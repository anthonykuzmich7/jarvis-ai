...
export function OrbitSyncJarvis() {
  ...
  return (
    <section
      id="product"
      className="relative flex min-h-[calc(100dvh-4rem)] scroll-mt-16 flex-col justify-center overflow-hidden my-20 sm:my-28"
    ...
    >
      ...
      <div ref={ref} className="relative mx-auto w-full max-w-6xl px-6 py-6 sm:py-8">
